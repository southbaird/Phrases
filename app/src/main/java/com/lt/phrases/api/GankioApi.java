...
import com.lt.phrases.model.bean.gankio.GankIoDayBean;
...
public interface GankioApi {
    ...
    Observable<GankIoCustomListBean> getGankIoCustomList(@Path("type") String type, @Path
            ("pre_page") int pre_page, @Path("page") int page);
    ...
    Observable<GankIoWelfareListBean> getGankIoWelfareList(@Path("pre_page") int pre_page, @Path("page") int page);
}
